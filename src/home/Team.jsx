            ...
            <div id={this.props.id} className='row' style={styles.main}>
                <div className='row col-xs-12 col-sm-5 col-sm-offset-1'>
                    <div className='col-xs-4'>
                        <img style={styles.image.full.image} src={"assets/images/" + this.state.b.full} alt="" />
                    </div>
                    <div className='col-xs-4'>
                        <img style={styles.image.full.image} src={"assets/images/" + this.state.t.full} alt="" />
                    </div>
                    <div className='col-xs-4'>
                        <img style={styles.image.full.image} src={"assets/images/" + this.state.c.full} alt="" />
                    </div>
                </div>
                ...
                <div className='col-xs-12 col-sm-5'>
                    <div className='row'>
                        ...
                        <a className='col-xs-4 pointer' onClick={toggleUser.bind(this, 'C')}>
                            <img style={styles.image.circle.image} src="assets/images/Ccloseup.png" alt="" />
                        </a>
                    </div>
